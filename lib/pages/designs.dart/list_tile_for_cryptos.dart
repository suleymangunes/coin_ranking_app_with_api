...
class ListTileDesign extends StatelessWidget {
  final index;
  const ListTileDesign(this.index, {Key? key}) : super(key: key);
      ...
      child: Card(
        ...
        elevation: 10,
          child: Padding(
            ...
            child: ListTile(
              onTap: (() {
                DialogDesignInfo().showMyDialog(context, index);
              }),
    ...
    return Container(  // resim container icerisinde box decorationda eklendi
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          ...
          image: NetworkImage("https://s2.coinmarketcap.com/static/img/coins/64x64/${controller.sonuclar[index][0]["id"]}.png"),
          )
      ),
      );
  }
      ...
      children: [
        Column(
          ...
          children: [
            SizedBox(
              child: Text(
                "\$${controller.sonuclar[index][0]["price"].toStringAsFixed(2)}",
                style: TextStyle(
                  fontWeight: context.fontWeight,
                  fontSize: 15
                ),
